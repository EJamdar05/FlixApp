...
class MovieDetails : YouTubeBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ratingScore = movie.rating.toFloat()
        ...
        client.get(VIDEO_URL.format(movie.movieID), object : JsonHttpResponseHandler() {
            override fun onFailure(statusCode: Int, headers: Headers?, response: String?, throwable: Throwable?
                ...
                Log.e(TAG, "onFail: $statusCode")
            }

            override fun onSuccess(statusCode: Int, headers: Headers?, json: JSON?) {
                Log.i(TAG, "Passed $statusCode")
                ...
                initializeYouTube(youtubeKey, ratingScore.toDouble())
            }
    ...
    private fun initializeYouTube(youtubeKey: String, ratingScore: Double) {
